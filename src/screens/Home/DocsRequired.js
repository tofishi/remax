...
import {
 ...
 const OnboardingScreen = ({navigation}) => {
  const [isSpeaner, setIsSpeaner] = useState(true);
    ...
    fetch('https://api.newhomesinorlando.net/getDocsRequiredReact', requestOptions)
       .then(async response => {
  ...
  return   (
    <View style={styles.screenContainer}>
        ...
        {isSpeaner && 
         ...
         <Text style={{fontSize:22,alignSelf:'center',color:'#62a0f7',fontWeight:'bold'}}> Docs Required</Text>
